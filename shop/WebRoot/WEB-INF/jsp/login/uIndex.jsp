...
<div class="width100" style="height: 45px;background: #dd4545;margin-top: 40px;position: relative;z-index: 100;">
    ...
    <div class="width1200 center_yh relative_yh" style="height: 45px;">
        ...
        <div class="left_yh Selected" style="width: 230px;height: 45px;" id="hiddenShow">
            ...
            <%--导航展开部分--%>
            <div class="downSlide">
                <c:forEach items="${libs}" var="data" varStatus="l">
                    <div class="n1Nav">
                        ...
                        <div class="n2Nav">
                            <div class="n3Nav">
                                ...
                                <c:forEach items="${data.children}" varStatus="ll" var="child">
        ...
        <div class="normalPic">
            <c:forEach items="${zks}" var="data" varStatus="l">
                <a href="${ctx}/item/view?id=${data.id}">
                    ...
                    <img src="${data.url1}" width="105" height="108" alt="" style="margin: 0 auto">
                </a>
            </c:forEach>
        </div>
    </div>
