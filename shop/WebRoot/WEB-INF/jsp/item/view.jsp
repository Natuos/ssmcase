...
<div class="width1198 center_yh" style="height: 420px;">
    <div class="left_yh" style="width: 350px;height: 420px;">
        ...
        <div id="preview">
            ...
            <div class="spec-list" style="margin-top: 5px;">
                <ul class="list-h">
                    <li><img src="${obj.url2}" height="80" width="80" alt=""></li>
                    <li><img src="${obj.url3}" height="80" width="80" alt=""></li>
                    <li><img src="${obj.url4}" height="80" width="80" alt=""></li>
                    <li><img src="${obj.url5}" height="80" width="80" alt=""></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div id="spPj">
                <div class="width100 hidden_yh" style="padding-bottom: 20px;border-bottom: 1px dashed #ddd;margin-bottom: 10px;">
                    <c:forEach items="${obj.pls}" var="data" varStatus="l">
                        <div style="width: 791px;float: right;overflow: hidden;margin-top: 20px;">
...
<script>
    ...
    * */
    ...
    //如果点击标签spDetil则选择商品信息显示，商品评价不显示（数组定位）
